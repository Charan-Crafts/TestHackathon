...
const EditChallenge = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setTitle(mockChallengeData.title);
      setDescription(mockChallengeData.description);
      setDifficulty(mockChallengeData.difficulty);
      setCategory(mockChallengeData.category);
      setTags(mockChallengeData.tags);
      setInputFormat(mockChallengeData.inputFormat);
      setOutputFormat(mockChallengeData.outputFormat);
      setConstraints(mockChallengeData.constraints);
      setExamples(mockChallengeData.examples);
      setTimeLimit(mockChallengeData.timeLimit);
      setMemoryLimit(mockChallengeData.memoryLimit);
      setStartingCode(mockChallengeData.startingCode);
      setTestCases(mockChallengeData.testCases);
      setStatus(mockChallengeData.status);
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        console.log('Updated challenge data to be sent to API:', updatedChallenge);
    ...
    <div className="container mx-auto px-4 py-6">
        ...
        <div className="bg-gradient-to-r from-gray-900/70 via-purple-900/40 to-gray-900/70 rounded-xl p-4 backdrop-blur-sm border border-purple-500/30 shadow-lg">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl text-white font-bold">Edit Challenge</h2>
                <p className="text-gray-300 text-sm sm:text-base">Modify an existing coding challenge</p>
              </div>
            </div>
      ...
      {showSuccess && (
        <div className="bg-green-900/30 border border-green-500/30 rounded-lg p-4 mb-6 flex items-center">
          ...
          <div>
            <p className="text-green-300 font-medium">Challenge updated successfully!</p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex">
                <input
                  type="text"
                  id="newTag"
                  className="flex-grow px-3 py-2 rounded-l-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">
                Active challenges are visible to users, drafts are saved but not visible, archived challenges are hidden but can be restored.
              </p>
            </div>
          </div>
        )}
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <div className="flex items-center">
                        ...
                        <label className="flex items-center text-sm">
                          <input
                            type="checkbox"
                            className="rounded bg-gray-900 text-blue-500 border-gray-700 mr-2"
