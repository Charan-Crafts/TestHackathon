        ...
        try {
            ...
            if (response.data.success) {
                ...
                if (response.data.data.isApproved) {
                    ...
                    toast.success('You are verified as an organizer! Please login to continue.');
        ...
        return (
            <>
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-bold text-white mb-4 bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">
                    ...
                    <div className="mt-4 p-3 bg-yellow-900/20 border border-yellow-600/20 rounded-md text-sm text-yellow-300">
                        <strong>Important Note:</strong> Once you submit this form, your account will be pending admin verification.
                        You will not have immediate access to organizer features until your profile is approved.
                        <div className="mt-2">
                            The organizer dashboard section will not be visible in your navigation until you are verified.
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className={`flex items-center ${step >= 1 ? 'text-indigo-500' : 'text-gray-500'}`}>
                            <div className={`flex items-center justify-center h-8 w-8 rounded-full border-2 ${step >= 1 ? 'bg-indigo-100 border-indigo-500' : 'bg-gray-100 border-gray-500'}`}>
                                <span className="text-sm font-medium">1</span>
                            </div>
                            <span className="ml-2 text-sm font-medium">Personal Details</span>
                        </div>
                        <div className={`w-full mx-4 border-t-2 ${step >= 2 ? 'border-indigo-500' : 'border-gray-300'}`}></div>
                        <div className={`flex items-center ${step >= 2 ? 'text-indigo-500' : 'text-gray-500'}`}>
                            <div className={`flex items-center justify-center h-8 w-8 rounded-full border-2 ${step >= 2 ? 'bg-indigo-100 border-indigo-500' : 'bg-gray-100 border-gray-500'}`}>
                                <span className="text-sm font-medium">2</span>
                            </div>
                            <span className="ml-2 text-sm font-medium">Organization Details</span>
                        </div>
                        <div className={`w-full mx-4 border-t-2 ${step >= 3 ? 'border-indigo-500' : 'border-gray-300'}`}></div>
                        <div className={`flex items-center ${step >= 3 ? 'text-indigo-500' : 'text-gray-500'}`}>
                            <div className={`flex items-center justify-center h-8 w-8 rounded-full border-2 ${step >= 3 ? 'bg-indigo-100 border-indigo-500' : 'bg-gray-100 border-gray-500'}`}>
                ...
                <div className="bg-gray-800 shadow rounded-lg p-6 border border-gray-700">
                    <h2 className="text-xl font-bold text-white mb-6 bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.fullName ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.email ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.phoneNumber ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    />
                                    {errors.phoneNumber && <p className="mt-1 text-sm text-red-500">{errors.phoneNumber}</p>}
                                </div>

                                <div>
                                    <label htmlFor="linkedinProfile" className="block text-sm font-medium text-gray-300">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="mt-1 block w-full px-3 py-2 bg-gray-900 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white"
                                    />
                                </div>

                                <div>
                                    <label htmlFor="photoIdProof" className="block text-sm font-medium text-gray-300">
                                        Photo ID Proof *
                                    </label>
                                    <div className="mt-1 flex items-center">
                                        <label className="relative flex-1 group">
                                            <div className="w-full px-3 py-2 bg-gray-900 border border-dashed border-indigo-500 rounded-md text-gray-300 cursor-pointer hover:bg-gray-800 transition">
                                    ...
                                    {formData.photoIdProofName && (
                                        <div className="mt-2 flex items-center p-2 bg-gray-900 rounded-md border border-gray-700">
                                            ...
                                            <span className="ml-2 text-sm text-gray-300">{formData.photoIdProofName}</span>
                                        </div>
                                    )}
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.organizationName ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    />
                                    {errors.organizationName && <p className="mt-1 text-sm text-red-500">{errors.organizationName}</p>}
                                </div>

                                <div>
                                    <label htmlFor="organizationType" className="block text-sm font-medium text-gray-300">
                                        Organization Type *
                                    </label>
                                    <select
                                        id="organizationType"
                                        ...
                                        onChange={handleChange}
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.organizationType ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    >
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={formData.role}
                                        onChange={handleChange}
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.role ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    />
                                    {errors.role && <p className="mt-1 text-sm text-red-500">{errors.role}</p>}
                                </div>

                                <div>
                                    <label htmlFor="organizationEmail" className="block text-sm font-medium text-gray-300">
                                        Organization Email *
                                    </label>
                                    <input
                                        type="email"
                                        ...
                                        onChange={handleChange}
                                        className={`mt-1 block w-full px-3 py-2 bg-gray-900 border ${errors.organizationEmail ? 'border-red-500' : 'border-gray-600'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-white`}
                                    />
                                    {errors.organizationEmail && <p className="mt-1 text-sm text-red-500">{errors.organizationEmail}</p>}
                                </div>

                                <div>
                                    <label htmlFor="organizationIdProof" className="block text-sm font-medium text-gray-300">
                                    ...
                                    {formData.organizationIdProofName && (
                                        <div className="mt-2 flex items-center p-2 bg-gray-900 rounded-md border border-gray-700">
                                            ...
                                            <span className="ml-2 text-sm text-gray-300">{formData.organizationIdProofName}</span>
                                        </div>
                                    )}
                        ...
                        {step === 3 && (
                            <div className="space-y-6">
                                <p className="text-gray-300 mb-4">Please review your information carefully before submitting. You will not be able to make changes after submission until verification is complete.</p>

                                <div className="bg-gray-900 rounded-lg border border-gray-700 p-4">
                                    <h3 className="text-lg font-medium text-indigo-400 mb-3">Personal Details</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white">{formData.linkedinProfile || 'Not provided'}</p>
                                        </div>
                                        <div className="md:col-span-2">
                                            ...
                                            <div className="flex items-center mt-1">
                                                ...
                                                <span className="ml-2 text-white">{formData.photoIdProofName}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gray-900 rounded-lg border border-gray-700 p-4">
                                    <h3 className="text-lg font-medium text-indigo-400 mb-3">Organization Details</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <p className="text-sm text-gray-500">Organization Name</p>
                                            <p className="text-white">{formData.organizationName}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500">Organization Type</p>
                                            <p className="text-white">{formData.organizationType}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white">{formData.organizationEmail}</p>
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex items-center mt-1">
                                                ...
                                                <span className="ml-2 text-white">{formData.organizationIdProofName}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <div className="bg-indigo-900/30 rounded-lg border border-indigo-500/30 p-4">
                                ...
                                <div className="mt-4">
                                    <button
                                        ...
                                        className="px-4 py-2 bg-gray-700 border border-gray-600 rounded-md text-gray-300"
                                    >
                                        Test File Upload
                                    </button>
                                </div>
                        ...
                        <div className="mt-8 flex justify-between">
                            {step > 1 && (
                                <button
                                    type="button"
                                    onClick={handleBack}
                                    className="px-4 py-2 border border-gray-600 text-gray-300 rounded-md shadow-sm text-sm font-medium hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                            ...
                            {step < 3 ? (
                                ...
                                <button
                                    type="submit"
                                    className="px-6 py-2 bg-indigo-600 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center"
                                    disabled={isSubmitting}
                                >
                                    {isSubmitting ? (
                                        <>
